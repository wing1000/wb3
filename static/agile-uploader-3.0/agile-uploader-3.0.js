(function($) {
	...
	*/
	...
	$.fn.agileUploader.defaults = {
		...
		flashSrc: '/static/agile-uploader-3.0/agile-uploader.swf',
		flashWidth: 25,
		flashHeight: 22,
		...
		flashVars: {
			...
			file_limit: -1,
			button_up:'/static/agile-uploader-3.0/add-file.png',
			button_over:'/static/agile-uploader-3.0/add-file.png',
			button_down:'/static/agile-uploader-3.0/add-file.png'		
		},
		progressBarColor: '#000000',
		attachScrollSpeed: 1000,		
		removeIcon: '/static/agile-uploader-3.0/trash-icon.png',
		genericFileIcon: '/static/agile-uploader-3.0/file-icon.png',
